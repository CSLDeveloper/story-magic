...
Write the complete story now, following the outline beat by beat:`;
    ...
    // --- Illustrations: page 1 only ---
    // Page 1 shows the hero portrait (generated by /api/illustrate pageNum=1).
    // All other pages have no illustration — text only.
    ...
    pages.forEach(p => {
      ...
      // Only page 1 gets an illustration: the hero portrait itself.
      // The description just needs to be truthy — /api/illustrate pageNum=1
      // uses heroPortraitPrompt, not this text.
      images.push(p.pageNum === 1 ? 'hero portrait' : null);
    });
